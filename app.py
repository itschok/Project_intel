...
def show_explanation2():
    ...
    - Random Forest
    - Logistic Regression
    - ผลลัพธ์ (0 = ไม่เป็นเบาหวาน, 1 = เป็นเบาหวาน)
    - ขั้นต่ำ Glucose = 140 ถึงจะเป็นเบาหวาน 
    """)
    st.markdown("""
...
|----------------------------|--------------------------------------------------|-----------|---------------|
| **Pregnancies**            | จำนวนครั้งที่ผู้ป่วยเคยตั้งครรภ์                | Integer   | 6             |
| **Glucose**                | ความเข้มข้นของกลูโคสในพลาสมา 2 ชั่วโมง          | Float     | 148.0         |
| **BloodPressure**          | ความดันโลหิต diastolic (mm Hg)                  | Float     | 72.0          |
| **SkinThickness**          | ความหนาของผิวหนังบริเวณ triceps (mm)             | Float     | 35.0          |
| **Insulin**                | ระดับอินซูลินในเลือด 2 ชั่วโมง (mu U/ml)        | Float     | 0.0           |
| **BMI**                    | ดัชนีมวลกาย (Body Mass Index)                   | Float     | 33.6          |
| **DiabetesPedigreeFunction**| ฟังก์ชันที่แสดงถึงประวัติครอบครัวเกี่ยวกับโรคเบาหวาน | Float     | 0.627         |
| **Age**                    | อายุของผู้ป่วย (ปี)                             | Integer   | 50            |
| **Outcome**                | ผลลัพธ์ (0 = ไม่เป็นเบาหวาน, 1 = เป็นเบาหวาน)   | Integer   | 1             |
""")
    st.write("""
    ### การเตรียมข้อมูล
    - โหลดข้อมูลจากไฟล์ CSV และตรวจสอบค่าที่หายไปและค่าผิดปกติ.
...
# สร้างเมนูแบบกด
tab1, tab2 ,tab3 ,tab4= st.tabs(["อธิบายแนวทางการพัฒนาโมเดล NN", "Demo การทำงานของโมเดล NN","อธิบายแนวทางการพัฒนาโมเดล ML","Demo การทำงานของโมเดล ML"])
